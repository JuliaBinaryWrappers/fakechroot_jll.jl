...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import fakechroot_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0d1115f3-e42e-5952-a93b-f179746a6ed7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "fakechroot", artifacts_toml) for e in artifacts["fakechroot"]]
...
if best_platform === nothing
    @debug("Unable to load fakechroot; unsupported platform $(triplet(platform_key_abi()))")
else
